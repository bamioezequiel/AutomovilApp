...
public class LoadData extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Alta de Automoviles");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        controller.createCar(this.txtBrand.getText(), this.txtColor.getText(),
                this.txtEngine.getText(), this.txtModel.getText(), 
                this.txtPatent.getText(), Integer.parseInt(this.sDoors.getValue().toString()));
